...
public interface ApiCalling {
    ...
    public  Call<ModelForDetailMovie> getDetailMovie(@Path("movie_id") int movie_id);

    //Get Movie Recommendations
    @GET("movie/{movie_id}/recommendations?api_key=7ca11e2b62de055509e9b58e13b6dcd5&language=en-US&page=1")
    public  Call<ModelForRecommendation> getModelRecommendations(@Path("movie_id") int movie_id);
